...
export type StorageHash =
  StorageHashBase<'15df823c3fe4dff19cbcbd34671f34804f86fdffa6e387cec8b7e7d5404230c8'>;
export type ExecutionHash =
  ExecutionHashBase<'9a95183e6e104303f0cd745220b1ab498e3c9ff28e2b85778c8f4306f8cb13ce'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Repository: {
      ...
      readonly defaultBranch: CodecTypes['pg/text@1']['output'];
      ...
      readonly status: 'IMPORTED' | 'ANALYZING' | 'READY' | 'FAILED';
...
export type FieldInputTypes = {
  readonly public: {
    readonly Repository: {
      ...
      readonly defaultBranch: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  export type public_Repository = {
    ...
    defaultBranch: CodecTypes['pg/text@1']['output'];
        ...
        readonly entries: {
            ...
            readonly repository: {
              columns: {
                ...
                readonly status: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'IMPORTED'>;
                  };
                };
                readonly createdAt: {
              ...
              uniques: readonly [{ readonly columns: readonly ['fullName'] }];
              indexes: readonly [];
          ...
          readonly valueSet: {
            readonly RepositoryStatus: {
              ...
              readonly values: readonly ['IMPORTED', 'ANALYZING', 'READY', 'FAILED'];
            };
          };
        };
      };
          ...
          readonly Repository: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly defaultBranch: { readonly column: 'defaultBranch' };
